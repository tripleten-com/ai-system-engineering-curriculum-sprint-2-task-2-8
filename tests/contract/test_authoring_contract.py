...
# Task 2.8 assesses five structured decision answers and changes no code. Keep
# this in sync with submission_validation.ALLOWED_PATHS, ALLOWED_PREFIXES, and
# the path gate in .github/workflows/protected-review.yml.
SUBMISSION_DIFF_ALLOWLIST = frozenset({"submission.yaml"})
SUBMISSION_DIFF_PREFIXES = ("tests/student/",)
HEADER_FIELDS = (
    "File:",
    "Component:",
    "Purpose:",
...
def test_submission_change_stays_within_the_permitted_diff() -> None:
    """Catch a submitted change that reaches outside Task 2.8's implementation boundary."""
    changed = {
